...
allows us to create a vertical projection profile. The skeletonization algorithm used is the scipy adaptation of \cite{zsthinning}. % TODO reference scipy
...
Most of the oversegmentation correction is done by our neural network.
