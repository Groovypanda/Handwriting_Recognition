...
We can do this because the text segmentation process will return the word in the image contained by its bounding box, so we will not change  % TODO:: NOTATION
