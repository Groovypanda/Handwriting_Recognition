...
CHAR_SEGMENTATION_TRAINING_PATH = DATA_PATH + 'segmentation/'
CHAR_SEGMENTATION_TRAINING_TXT_PATH = CHAR_SEGMENTATION_TRAINING_PATH + 'segmentation.txt'

TOKENIZATION_PATH = PROJECT_PATH + 'Tokenization/'
CHAR_SEGMENTATION_NET_SAVE_PATH = TOKENIZATION_PATH + 'Model/model.ckpt'